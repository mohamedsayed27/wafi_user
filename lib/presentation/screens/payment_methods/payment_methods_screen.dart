...
class _PaymentMethodsScreenState extends State<PaymentMethodsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(preferredSize: preferredSize, child: const CustomAppBar(title: "Payment Methods",elevation: 10,),),
      body: ListView(
              ...
              return Row(
                children: [
                  Container(
                    ...
                    child: SvgPicture.asset(SvgPath.masterCard,width: 30.w,height: 18.h,),
                  ),
